...
tstart = datetime(2021,6,20,0,0,0)
tend = datetime(2021,6,20,0,1,30)
xtickformat('mm:ss')
xlim([tstart tend])
...
annotation('textbox',[0.90168 0.3385 0.05937 0.02824],'String','UBUNTU-GPOS','EdgeColor','none','Color','blue')
annotation('textbox',[0.90168 0.3085 0.05937 0.02824],'String','UBUNTU-RTOS','EdgeColor','none','Color','black')
annotation('textbox',[0.90168 0.2785 0.05937 0.02824],'String','PARDUS-GPOS','EdgeColor','none','Color','red')
annotation('textbox',[0.90168 0.2485 0.05937 0.02824],'String','PARDUS-RTOS','EdgeColor','none','Color','green')
